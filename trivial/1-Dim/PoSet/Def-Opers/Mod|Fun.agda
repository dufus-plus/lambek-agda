...
-- import 2-Dim-Pre.PoSet-Qu.Def-Types.Obj as PoSet-Graph
...
-- Mod|Fun:PQ|PQ .H|V-2Mor = [Mod|Fun]

-- open PoCat|PoCat.:[is-Obj] Mod|Fun:PQ|PQ Fun.oper Mod.oper
...
--   is-PC|PC : PoCat|PoCat.[is-Obj] Mod|Fun:PQ|PQ Fun.oper Mod.oper
