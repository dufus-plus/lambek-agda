...
module 2-Dim.PoCat.Def-Opers.Hom|Hom
  ...
  (let C' = To-Opp C) (let module C' = [Obj] C') where
...
open PoCat|PoCat.:[is-Obj] C.Ob C'.is C.is Hom|Hom.R|R
...
Hom|Hom-is-PC|PC : PoCat|PoCat.[is-Obj] C.Ob C'.is C.is Hom|Hom.R|R
