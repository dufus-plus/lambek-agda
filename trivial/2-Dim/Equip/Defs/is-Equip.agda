...
open import 2-Dim.PoSet-Gra.Defs.PoSet-Gra-Ob
open import 2-Dim.PoSet-DblGra.Defs.PoSet-DblGra-Ob
open import 2-Dim.PoCat.Defs.is-PoCat

module 2-Dim.Equip.Defs.is-Equip where

open PoSet.[PoSet]
open PoSet.[Fun]

module :is-Equip
       (DblGra @(‼ $Ob V-Mor H-Mor H|V-Mor) : [PoSet-DblGra])
       (V-oper @(‼ VId VMu): [oper-PoCat] (V-Gra DblGra))
       (H-oper @(‼ HId HMu): [oper-PoCat] (H-Gra DblGra))
      where
...
module _ (DblGra : [PoSet-DblGra])
         (V-oper : [oper-PoCat] (V-Gra DblGra))
         (H-oper : [oper-PoCat] (H-Gra DblGra))
      where
  record [is-Equip] : [Any] where
    constructor ‼
    open :is-Equip DblGra V-oper H-oper
