...
module _ (Ob : [Any]) (Hom : :Hom Ob) where
  ...
  module :[Obj-oper]  where
    ...
    :Dagg = Matr.PoSet-[S-Fun] _ (Hom > Hom)
  ...
  record [Obj-oper] : [Any] where
    ...
    private module Dagg (2ob : _) = PoSet.[Fun] (Dagg 2ob)
    open Dagg public
      using ()
      renaming
      ( f-el to Dagg-el;
  ...
  module :[Obj-prop] (oper : [Obj-oper]) where
    ...
    :id-dagg-fw =
      (ob : Ob) → Hom.To _ (Id ob ~ Dagg-el _ (Id ob))
    :id-dagg-bw =
      (ob : Ob) → Hom.To _ (Dagg-el _ (Id ob) ~ Id ob)
    :mu-dagg-fw =
      (3ob @(ob1 ~ ob2 ~ ob3) : [3~] Ob)
      (2hom @ (hom12 × hom23) : Hom.El (ob1 ~ ob2) [×] Hom.El (ob2 ~ ob3)) →
      Hom.To _ (Mu-el _ (Dagg-el _ hom23 × Dagg-el _ hom12) ~ Dagg-el _ (Mu-el _ 2hom))
    :mu-dagg-bw =
      (3ob @(ob1 ~ ob2 ~ ob3) : [3~] Ob)
      (2hom @ (hom12 × hom23) : Hom.El (ob1 ~ ob2) [×] Hom.El (ob2 ~ ob3)) →
...
module _ (Ob : [Any]) (Hom : :Hom Ob) where
  ...
  Hom-Opp-oper oper .Dagg _ .↓ .f-el h12 = oper .Dagg-el _ h12
  Hom-Opp-oper oper .Dagg _ .↓ .f-to _ hto = oper .Dagg-to _ _ hto
  ...
  To-Opp-oper oper .Dagg _ .↓ .f-el h12 = oper .Dagg-el _ h12
  To-Opp-oper oper .Dagg _ .↓ .f-to _ hto = oper .Dagg-to _ _ hto
...
module _ (Ob : [Any]) (Hom : :Hom Ob) (oper : [Obj-oper] Ob Hom) where
  ...
  Hom-Opp-prop prop .id-dagg-fw _ = prop .id-dagg-fw _
  ...
  To-Opp-prop prop .id-dagg-fw = prop .id-dagg-bw
