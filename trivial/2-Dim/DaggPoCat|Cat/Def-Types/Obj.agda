...
--
module 2-Dim.DaggPoCat|Cat.Def-Types.Obj where

open PoCat using (‼)
open DaggPoSet|Set-Qu using (‼)

-- base module
open import 2-Dim.DaggPoCat|Cat.Def-Types.is-Obj public
...
record [Obj] : [Any] where
  ...
  open Matr.[DaggPoSet|Set] H|V public
