...
import 2-Dim.Cat|Cat.Def-Types.is-Obj as Cat|Cat
open import 2-Dim.Cat|Cat.Def-Types-pub.is-Obj

module 2-Dim.Cat.Def-Opers.Hom|Hom where
...
module _
  ...
  module Hom|Hom where
    ...
    R|R : Matr.[Set|Set] _ (2~ C.Hom) (2~ C'.Hom)
    R|R .Sqr = [Hom|Hom] C
  ...
  open Cat|Cat.:[is-Obj] C.Ob C'.is C.is Hom|Hom.R|R
  ...
  Hom|Hom-is-PC|PC : Cat|Cat.[is-Obj] C.Ob C'.is C.is Hom|Hom.R|R
