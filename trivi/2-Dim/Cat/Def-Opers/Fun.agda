...
import 1-Dim.Set.Def-Opers.Fun as Set
open import 1-Dim.Set.Def-Types-pub
open import 1-Dim.Graph.!publi
import 2-Dim-Pre.Set-Qu.Def-Types as Set-Qu
open import 2-Dim-Pre.Set-Qu.Def-Types-pub
import 3-Dim-Pre.2-Matr.Def-Types as 2-Matr
open import 2-Dim.Cat.Def-Types
open import 2-Dim.Cat.Def-Types-pub
open import 2-Dim.Cat.Def-Gens.Objs
open import 2-Dim.Cat.Def-Gens.Fun
open import 2-Dim.Cat.Def-Opers.Hom|Hom

module 2-Dim.Cat.Def-Opers.Fun where

Fun-Id : 2-Matr.Cat-[0-Fun] _ (! > Fun)
Fun-Id C .f-ob        = Any.Fun-Id _
Fun-Id C .is .f-hom _ = Set.Fun-Id _
...
Fun-Mu : 2-Matr.Cat-[2-Fun] _ ((Fun × Fun) > Fun)
Fun-Mu (A ~ B ~ C) .f-ob (Fab × Fbc) .f-ob = Any.Fun-Mu _ (Fab .f-ob × Fbc .f-ob)
Fun-Mu (A ~ B ~ C) .f-ob (Fab × Fbc) .is .f-hom _ = Set.Fun-Mu _ .f-el (Fab .f-hom _ × Fbc .f-hom _)
