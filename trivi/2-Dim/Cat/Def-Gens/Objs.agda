...
import 1-Dim.Set.Def-Gens as Set
...
import 2-Dim-Pre.Set-Qu.Def-Gens.Objs as Set-Qu

module 2-Dim.Cat.Def-Gens.Objs where

Unit : [Obj]
Unit     .Ob  = Set-Qu.Unit .Ob
Unit .is .Hom = Set-Qu.Unit .Hom
Unit .is .oper .Id _ = !
Unit .is .oper .Mu _ = Set.Unit.Term _
...
Void : [Obj]
Void     .Ob  = Set-Qu.Void .Ob
Void .is .Hom = Set-Qu.Void .Hom
Void .is .oper .Id ()
Void .is .oper .Mu ()
...
module _ (AB @(A × B) : [2×] [Obj]) where
  Prod2 : [Obj]
  Prod2     .Ob  = Set-Qu.Prod2 (Qu A × Qu B) .Ob
  Prod2 .is .Hom = Set-Qu.Prod2 (Qu A × Qu B) .Hom
...
module _ (AB @(A + B) : [2×] [Obj]) where
  Summ2 : [Obj]
  Summ2     .Ob  = Set-Qu.Summ2 (Qu A + Qu B) .Ob
  Summ2 .is .Hom = Set-Qu.Summ2 (Qu A + Qu B) .Hom
